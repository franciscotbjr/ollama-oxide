//! Example: Chat completion with streaming and thinking enabled (async)
//!
//! Prints reasoning (`thinking`) then the assistant reply (`content`) as NDJSON chunks arrive.
//!
//! Run with: `cargo run --example chat_stream_think_async`
//!
...
use ollama_oxide::{
    ChatMessage, ChatRequest, ChatResponse, OllamaApiAsync, OllamaClient, ThinkSetting,
};
